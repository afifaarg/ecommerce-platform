...
export default function AuthentificationModal() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="w-1/3 bg-white mx-auto rounded-lg p-8 transition duration-500 ease-in-out transform">
                <h1 className="text-2xl text-primary text-center uppercase font-semibold">Authentification</h1>
                
                {/* Tab Buttons */}
                <div className="w-1/2 mx-auto flex justify-between mt-4">
                    <span
                        onClick={() => setActiveTab("signin")}
                        className={`p-4 cursor-pointer transition duration-300 ${activeTab === "signin" ? "text-primary border-b-2 border-primary" : "text-gray-500"}`}
                    >
                        Connexion
                    </span>
                    <span
                        onClick={() => setActiveTab("signup")}
                        className={`p-4 cursor-pointer transition duration-300 ${activeTab === "signup" ? "text-primary border-b-2 border-primary" : "text-gray-500"}`}
                    >
                        Inscription
                    </span>
                </div>
