...
>
    ...
    <div className="mb-4 flex items-center justify-between gap-4">
        ...
        {product.category === "Mattresses" ? "New Arrival" : "Best Seller"}
        </span>
    ...
    <div className="mt-4 flex items-center justify-between gap-4">
        ...
        <button
        type="button"
        className="inline-flex items-center rounded-lg bg-primary  px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
        <svg
